                    ...
                    <div class="card-body">
                        ...
                        <form action="../app/iptmsHandler.php" method="post">
                          <div>
                            ...
                            <input type="hidden" class="form-control" name="r"  value="<?php echo $capture->regNo; ?>" >
                          ...
                          <div>
                            ...
                            <input type="text" class="form-control" name="i"  value="<?php echo $capture->instituteName; ?>"readonly >
