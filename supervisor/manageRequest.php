                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              ...
                              ?>
                                  <a href="acceptedRequest.php?rid=<?php echo $row->requestID; ?>&stid=<?php echo $row->studentID; ?>" class="btn btn-warning text-white mb-3" title="Accept request"><span class="fe fe-check-square fe-16"></span></a>
                              <?php
                                } else {
                              ?>
                                <a href="assignedSupervisor.php" class="btn btn-success text-white mb-3" title="View assigned request"><span class="fe fe-eye fe-16"></span></a>
                              <?php
                                }
                               ?>
                            </td>
