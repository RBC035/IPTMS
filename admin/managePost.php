                  ...
                  <div class="card " style="box-shadow: 0 0 .5rem rgba(0, 0, 0, .2); ">
                    <div class="card-body">
                      ...
                      <table class="table datatables table-bordered table-hover" id="dataTable-1">
                        ...
                        <?php 
                                $no = 1;
                                $post = $con->prepare("select * from post ");
                                $post->execute();
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $row->status == "Opening" ? 'Active' : $row->status; ?></td>
                            <td class="text-center">
                              <a href="viewRequest.php?i=<?php echo $row->postID; ?>" class="btn btn-success text-white "><span class="fe fe-eye fe-16"></span></a>
                            </td>
                          </tr>
                        <?php $no +=1; } ?>
